    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="24">
        <blockquote class="text-warning" style="font-size: 14px">
          ...
          <br />
          阿里云服务器折扣区
          <el-link href="http://aly.spoa.vip" type="primary" target="_blank"
            >>☛☛点我进入☚☚</el-link
          >
          &nbsp;&nbsp;&nbsp; 腾讯云服务器秒杀区
          <el-link href="http://txy.spoa.vip" type="primary" target="_blank"
            >>☛☛点我进入☚☚</el-link
          ><br />
      ...
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        ...
        <p>
          <el-button
            ...
            icon="el-icon-cloudy"
            plain
            @click="goTarget('https://gitee.com/y_project/spoa-Vue')"
            >访问码云</el-button
          >
          <el-button
            size="mini"
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> 官网：<el-link
                href="http://www.spoa.vip"
                target="_blank"
                >http://www.spoa.vip</el-link
              >
            </p>
            <p>
